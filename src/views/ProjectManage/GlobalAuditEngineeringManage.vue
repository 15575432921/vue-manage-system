...
export default {
  ...
  methods: {
    ...
    getList (name = '') {
      ...
      axios._get("/project/getCheckProject?projectType=工程审计").then(res => {
      ...
      this.$confirm("此操作将审核通过该项目, 是否继续?", "提示", {
        ...
        type: "warning"
          ...
          .then(() => {
            ...
            axios._post('/project/globalpass', formdata).then(res => {
              if (res.code == "250") {
                this.$message({
                  type: "error",
                  message: "已有审核人处理此项目！"
      ...
      this.$confirm("此操作将退回该项目, 是否继续?", "提示", {
        ...
        type: "warning"
          ...
          .then(() => {
            ...
            axios._post('/project/globalrefuse', formdata).then(res => {
              if (res.code == "250") {
                this.$message({
                  type: "error",
                  message: "已有审核人处理此项目！"
